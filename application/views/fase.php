<h3 class="page-header" style="color:#086788";><b>Fase</b></h3>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                                    ...
                                    <div class="box-body form-vertical">
                                        ...
                                        <div class="form-group col-md-5">
                                            <div class="btn-group" role="group" aria-label="First group">
                                                <button id="btn_nuevo" type="button" class="btn btn-primary btn-sm" onclick="nuevo_fase()"><strong>NUEVA FASE&nbsp;&nbsp;&nbsp;</strong><span class="fa fa-plus-circle"></span></button>                                                    
                        ...
                        <table id="tabla" class="table table-hover table-condensed table-striped" style="width: 100%; cellspacing: 0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" style="vertical-align: middle;">Fase</th>
                                ...
                                <?php if(!empty($entidades)):   ?>             
                                    <?php foreach($entidades as $entidad):?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" style="vertical-align: middle;"><?php echo $entidad->fase_codigo;?></td>          
                                            <td class="text-center" style="vertical-align: middle;"><?php echo $entidad->fase_nombre;?></td>
                                            <td class="text-center" style="vertical-align: middle;"><?php echo $entidad->fase_descripcion;?></td>
                                            ...
                                            ?>
                                            <td class="text-center" style="vertical-align: middle;"><a onclick="cambiar_fase(<?php echo $entidad->fase_id;?>)"><i class="fa fa-pencil fa-2x"></i></a>&nbsp;&nbsp;&nbsp;<a onclick="quitar_fase(<?php echo $entidad->fase_id;?>)"><i class="fa fa-trash fa-2x"></i></a></td>
                                        </tr>
                                    <?php endforeach;   ?>
                                <?php endif;    ?>
                            </tbody>
        ...
        <div class="modal fade" id="modal_fase"
                        ...
                        <div class="row" align="center">
                            <div class="col-md-12" align="center">                            
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input id="fase_codigo" style="text-transform: uppercase"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input id="fase_nombre" style="text-transform: uppercase"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <textarea id="fase_descripcion" style="text-transform: uppercase"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label style="width: 100%" class="control-label col-md-6">Área</label>
                                            <div class="col-md-12">

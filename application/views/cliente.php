<h3 class="page-header" style="color:#086788";><b>Cliente</b></h3>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                                    ...
                                    <div class="box-body form-vertical">
                                        ...
                                        <div class="form-group col-md-5">
                                            <div class="btn-group" role="group" aria-label="First group">
                                                <button id="btn_nuevo" type="button" class="btn btn-primary btn-sm" onclick="nuevo_cliente()"><strong>NUEVO CLIENTE&nbsp;&nbsp;&nbsp;</strong><span class="fa fa-plus-circle"></span></button>                                                    
                        ...
                        <table id="tabla" class="table table-hover table-condensed table-striped" style="width: 100%; cellspacing: 0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" style="vertical-align: middle;">Ruc</th>
                                ...
                                <?php if(!empty($entidades)):   ?>             
                                    <?php foreach($entidades as $entidad):?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" style="vertical-align: middle;"><?php echo $entidad->cliente_codigo;?></td>    
                                            <td class="text-center" style="vertical-align: middle;"><?php echo $entidad->cliente_documento;?></td>     
                                            <td class="text-center" style="vertical-align: middle;"><?php echo $entidad->cliente_razon;?></td>
                                            <td class="text-center" style="vertical-align: middle;"><?php echo $entidad->cliente_telefono;?></td>
                                            <td class="text-center" style="vertical-align: middle;"><?php echo $entidad->cliente_correo;?></td>
                                            ...
                                            ?>
                                            <td class="text-center" style="vertical-align: middle;"><a onclick="cambiar_cliente(<?php echo $entidad->cliente_id;?>)"><i class="fa fa-pencil fa-2x"></i></a>&nbsp;&nbsp;&nbsp;<a onclick="quitar_cliente(<?php echo $entidad->cliente_id;?>)"><i class="fa fa-trash fa-2x"></i></a></td>
                                        </tr>
                                    <?php endforeach;   ?>
                                <?php endif;    ?>
                            </tbody>
                        ...
                        <div class="row" align="center">
                            <div class="col-md-12" align="center">                            
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input id="cliente_codigo" style="text-transform: uppercase"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label style="width: 100%" class="control-label col-md-6">Ruc</label>
                                            <div class="col-md-12">
                                                <input id="cliente_documento" style="text-transform: uppercase"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label style="width: 100%" class="control-label col-md-6">Razon social</label>
                                            <div class="col-md-12">
                                                <input id="cliente_razon" style="text-transform: uppercase"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label style="width: 100%" class="control-label col-md-6">Teléfono</label>
                                            <div class="col-md-12">
                                                <input id="cliente_telefono" style="text-transform: uppercase"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input id="cliente_correo" style="text-transform: uppercase"
                                                        placeholder="Correo" required
                                                        class="form-control mayusculas" type="email"> <span class="help-block"></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">

    ...
    <div class="container">
        <div class="card card-container">
            ...
            <form action="<?php echo base_url();?>login/login" method="post">
                <input type="text" class="form-control" style="text-transform:uppercase;" id="usuario_usuario" name="usuario_usuario" placeholder="Usuario" required autofocus>
                <label id="valiusuario" style="color: #d32f2f"></label>
                <input type="password" class="form-control" id="usuario_clave" name="usuario_clave" placeholder="Contraseña" required autofocus>

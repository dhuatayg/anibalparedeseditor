                <h3 class="page-header" style="color:#086788";><b>Rol</b></h3>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                                    ...
                                    <div class="box-body form-vertical">
                                        ...
                                        <div class="form-group col-md-5">
                                            <div class="btn-group" role="group" aria-label="First group">
                                                <button id="btn_nuevo" type="button" class="btn btn-primary btn-sm" onclick="nuevo_rol()"><strong>NUEVO ROL&nbsp;&nbsp;&nbsp;</strong><span class="fa fa-plus-circle"></span></button>                                                    
                                ...
                                <?php if(!empty($entidades)):   ?>             
                                    <?php foreach($entidades as $entidad):?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" style="vertical-align: middle;"><?php echo $entidad->rol_codigo;?></td>          
                                            <td class="text-center" style="vertical-align: middle;"><?php echo $entidad->rol_nombre;?></td>
                                            <td class="text-center" style="vertical-align: middle;"><?php echo $entidad->rol_descripcion;?></td>
                                            ...
                                            ?>
                                            <td class="text-center" style="vertical-align: middle;"><a onclick="cambiar_rol(<?php echo $entidad->rol_id;?>)"><i class="fa fa-pencil fa-2x"></i></a>&nbsp;&nbsp;&nbsp;<a onclick="quitar_rol(<?php echo $entidad->rol_id;?>)"><i class="fa fa-trash fa-2x"></i></a></td>
                                        </tr>
                                    <?php endforeach;   ?>
                                <?php endif;    ?>
                            </tbody>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input id="rol_codigo" style="text-transform: uppercase"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input id="rol_nombre" style="text-transform: uppercase"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <textarea id="rol_descripcion" style="text-transform: uppercase"

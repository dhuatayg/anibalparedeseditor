<h3 class="page-header" style="color:#086788";><b>Maquina</b></h3>
        ...
        <div class="modal fade" id="modal_maquina"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input id="maquina_codigo" style="text-transform: uppercase"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input id="maquina_nombre" style="text-transform: uppercase"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <textarea id="maquina_descripcion" style="text-transform: uppercase"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input id="maquina_cantidad" style="text-transform: uppercase"

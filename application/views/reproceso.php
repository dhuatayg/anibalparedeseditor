<h3 class="page-header" style="color:#086788";><b>Reproceso</b></h3>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                                    ...
                                    <div class="box-body form-vertical">
                                        ...
                                        <div class="form-group col-md-5">
                                            <div class="btn-group" role="group" aria-label="First group">                                          
                                                <button type="button" id="busqueda_reproceso" class="btn btn-primary btn-sm"><strong>BUSQUEDA&nbsp;&nbsp;&nbsp;</strong><span class="fa fa-search"></span></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>

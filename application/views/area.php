<h3 class="page-header" style="color:#086788" ;><b>Área</b></h3>
</div>
</div>
<div class="row">
    <div class="col-md-12">
                            ...
                            <div class="box-body form-vertical">
                                ...
                                <div class="form-group col-md-5">
                                    <div class="btn-group" role="group" aria-label="First group">
                                        <button id="btn_nuevo" type="button" class="btn btn-primary btn-sm" onclick="nuevo_area()"><strong>NUEVA ÁREA&nbsp;&nbsp;&nbsp;</strong><span class="fa fa-plus-circle"></span></button>
                ...
                <table id="tabla" class="table table-hover table-condensed table-striped" style="width: 100%; cellspacing: 0">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" style="vertical-align: middle;">Área</th>
                        ...
                        <?php if (!empty($entidades)) :   ?>
                            <?php foreach ($entidades as $entidad) : ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" style="vertical-align: middle;"><?php echo $entidad->area_codigo; ?></td>
                                    <td class="text-center" style="vertical-align: middle;"><?php echo $entidad->area_nombre; ?></td>
                                    <td class="text-center" style="vertical-align: middle;"><?php echo $entidad->area_descripcion; ?></td>
                                    ...
                                    ?>
                                    <td class="text-center" style="vertical-align: middle;"><a onclick="cambiar_area(<?php echo $entidad->area_id; ?>)"><i class="fa fa-pencil fa-2x"></i></a>&nbsp;&nbsp;&nbsp;<a onclick="quitar_area(<?php echo $entidad->area_id; ?>)"><i class="fa fa-trash fa-2x"></i></a></td>
                                </tr>
                            <?php endforeach;   ?>
                        <?php endif;    ?>
                    </tbody>
...
<div class="modal fade" id="modal_area" role="dialog" aria-labelledby="myModalLabel">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="area_codigo" style="text-transform: uppercase" placeholder="Código" required readonly class="form-control mayusculas" type="text"> <span class="help-block"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="area_nombre" style="text-transform: uppercase" placeholder="Nombre" required class="form-control mayusculas" type="text"> <span class="help-block"></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <textarea id="area_descripcion" style="text-transform: uppercase" placeholder="Descripcion" required class="form-control mayusculas" type="text"> </textarea><span class="help-block"></span>
                                    </div>
                                </div>
                            </div>
                        </div>
